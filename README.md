...
* Bankroll changes persist to Supabase. Every wager adjustment schedules a sync to the `profiles.credits` column, and the simulator reloads that stored balance on sign-in so refreshing the page no longer resets your units.
