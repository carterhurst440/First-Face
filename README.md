...
2. The compact header stays pinned to the top of the screen with your bankroll readout, a combined chart icon, a slim reset button, the theme selector, and the hamburger menu. Flip the theme dropdown to instantly restyle the table with **Retro**, **Cotton Candy**, or **Pastel** palettes. After each hand the bankroll flashes green or red, counts up or down to the new total, and any panel drawers can be opened or closed without leaving the table.
